...
There are five HMSFRs that are clearly separate from the rest. These five are indicated in red in all four panels of the figure. 
We will refer to these five as the outliers.

We can interpret the existence of these outliers as a consequence of the imperfection of our solution technique, as a consequence of some pathology of the specific sightlines they lie on, as a consequence of a property they all share, or as a consequence of some combination of these possibilties.
In the first case, there is some probability of KT catastrophically failing along any given sightline. 
If the HMSFRs are assumed to be representative THEN HERE'S THE FAILURE RATE
